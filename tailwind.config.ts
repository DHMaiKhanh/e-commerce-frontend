...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        'brand-gradient': 'linear-gradient(120deg, #4338ca 0%, #6366f1 45%, #818cf8 100%)',
      ...
      boxShadow: {
        soft: '0 2px 8px -2px rgba(16,24,40,0.06), 0 4px 16px -4px rgba(16,24,40,0.05)',
